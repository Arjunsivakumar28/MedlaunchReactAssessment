...
function FormPage() {
    ...
    let backButton
    if (step > 1) {
        backButton = <button type="button" className="text-[#0056A3] hover:text-white border border-[#0056A3] hover:bg-[#0056A3] font-bold rounded-lg text-base px-8 py-4.5 text-center ms-2"
            onClick={back}>Previous</button>
    } else {
        backButton = <button type="button" className="text-[#0056A3] hover:text-white border border-[#0056A3] hover:bg-[#0056A3] font-bold rounded-lg text-base px-8 py-4.5 text-center ms-2">Exit</button>
    }

    let frontButton
    if (step < 6) {
        frontButton = <button type="button" className="text-white hover:text-white border border-[#0056A3] bg-[#0056A3] hover:bg-[#004b8f] font-bold rounded-lg text-base px-8 py-4.5 text-center ms-4"
            onClick={next}>Continue</button>
    } else {
        frontButton = <button type="button" className="text-white hover:text-white border border-[#0056A3] bg-[#0056A3] hover:bg-[#004b8f] font-bold rounded-lg text-base px-8 py-4.5 text-center ms-auto">Submit Application</button>
    }

    return (
        <div className='container w-full min-h-screen bg-[#F6F6F6] flex flex-col items-center'>
            <div className='top-banner justify-center flex items-center p-6 mb-5 w-full h-24 bg-[#1A3A70]'>
                <div className='banner-title flex justify-start item-center w-full max-w-300 h-12 bg-transparent'>
                    <div className='text-3xl font-bold text-white' >DNV Healthcare</div>
                </div>
            </div>
            <div className='card-title flex flex-col justify-center items-center mb-5 w-240 h-30 bg-transparent'>
                <div className='card-name w-full flex justify-between items-center mb-2'>
                    ...
                    <div className='text-center text-lg font-medium text-[#343434]'>Step {step} of 6</div>
                </div>

                <div className="progress-bar flex space-x-2 w-full mb-4">
                    {[1, 2, 3, 4, 5, 6].map((s) => (
                        <div key={s} className='flex flex-col justify-center items-center w-full'>
                            <div
                                className={`w-full h-2 mb-2 rounded ${s <= step ? "bg-[#0056A3]" : "bg-gray-300"}`}
                            />
            ...
            <div className='component-section px-8 pb-16 pt-10 mb-5 w-240 min-h-105 bg-white rounded-md shadow-md flex flex-col justify-center items-center'>
