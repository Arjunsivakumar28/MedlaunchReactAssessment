...
export const EmailAddress = ({address, setAddress, verify, setVerify}) => {
  ...
  return (
    <div name='email-address' className='email-address flex flex-col items-start justify-start w-full'>
        ...
        <input onChange={(e) => setAddress(e.target.value)} name='email' type='text' defaultValue={address} id='email' className='w-full bg-transparent rounded-lg border border-[#4E4E4E] text-base text-[#4E4E4E] p-3 mb-3'/>
